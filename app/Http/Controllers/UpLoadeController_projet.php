...
class UpLoadeController_projet extends Controller
{
    public function Upload(Request $request)
    {
        ...
        $id = Post_proj::create(['name' => $title, 'content' => $content, 'vin' => $file_name_vin, 'couverture' => $file_name_couverture, 'view' => 0,'comm'=>0,'date_diff' => $date_diff])->id;
